...
app.directive('ionicDatepicker', ['$ionicPopup', 'DatepickerService', function ($ionicPopup, DatepickerService) {
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            //console.log(scope.previousDay);
            if (typeof scope.previousDay === 'undefined') {
                scope.previousDayEpoch = (+(new Date()) - 86400000);
            } else {
                scope.previousDayEpoch = (+(scope.previousDay) );
            }
                ...
                $ionicPopup.show({
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            onTap: function (e) {
                                scope.date_selection.submitted = true;//console.log(scope.variable);
                                if (scope.date_selection.selected === true) {
                                    scope.ipDate = angular.copy(scope.date_selection.selectedDate);
                                    scope.callback(scope.ipDate, scope.variable);
                                } else {
                                    e.preventDefault();
                                }
                            }
